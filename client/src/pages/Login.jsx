        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <input id="login-password" name="password" type="password" className="form-input"
              placeholder="Enter your password" value={form.password} onChange={handleChange} autoComplete="current-password" />
          </div>
          
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '30px' }}>
            <Link to="/register" style={{ color: '#3ea6ff', fontSize: '14px', fontWeight: '500' }}>Create account</Link>
            <button type="submit" disabled={loading} id="login-submit-btn" style={{
